        ...
        <div class="right">
            ...
            <div class="style2 ">
                <div class="style2_t">
                    <div class="style2_tr">
                        ...
                        echo '<h3 id="ititle">';
                            ...
                            echo '<a href="####">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="page.php?i=3">合作机构</a>&nbsp;&gt;&gt;&nbsp;<a href="">'.$row['title'].'</a>';
                        ?>
                    </span>
                ...
                <div class="style2_c p10_20_20">
                    <form method="post" action="cooperationForm.php">
                        <textarea name="content" class="style2_show lh30" id="icontent" style="width:100%;height:500px; " ><?php
                            include_once '../login/conn.php';
                            @mysql_select_db($database) or die('can not find database!');
                        ...
                        <input id="hiddenValue" type="text" name="hiddenValue" value=<?php echo '"'.$_GET["id"].'"' ?> style="display: none" />
